...
public class previous_3_5 extends Fragment {
        ...
        call.enqueue(new Callback<PhonePreviousResponse>() {
            ...
            public void onResponse(Call<PhonePreviousResponse> call, Response<PhonePreviousResponse> response) {
                ...
                if(response.body().getData().size()==0){
                    ...
                    nativeAdIds.add(getResources().getString(R.string.previous_3_5_a)); //previous top native
                    nativeAdIds.add(getResources().getString(R.string.previous_3_5_b)); //previous middle native
                    nativeAdIds.add(getResources().getString(R.string.previous_3_5_c)); //previous bottom native

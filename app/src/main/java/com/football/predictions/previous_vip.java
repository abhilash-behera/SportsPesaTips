 ...
 */
public class previous_vip extends Fragment {
...
*/      progressBar=rootView.findViewById(R.id.progressBar);
        ...
        Call<PhonePreviousResponse> call= ApiClient.getClient().getPhonePreviousVip();
        call.enqueue(new Callback<PhonePreviousResponse>() {
            ...
            public void onResponse(Call<PhonePreviousResponse> call, Response<PhonePreviousResponse> response) {
                ...
                if(response.body().getData().size()==0){
                    ...
                    nativeAdIds.add(getResources().getString(R.string.previous_vip_a)); //previous top native
                    nativeAdIds.add(getResources().getString(R.string.previous_vip_b)); //previous middle native
                    nativeAdIds.add(getResources().getString(R.string.previous_vip_c)); //previous bottom native

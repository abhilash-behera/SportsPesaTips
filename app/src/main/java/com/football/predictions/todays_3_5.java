...
public class todays_3_5 extends Fragment {
        ...
        call.enqueue(new Callback<PhoneTodayResponse>() {
            ...
            public void onResponse(Call<PhoneTodayResponse> call, Response<PhoneTodayResponse> response) {
                ...
                if(response.body().getData().size()==0){
                    ...
                    nativeAdIds.add(getResources().getString(R.string.todays_3_5_a));//previous top native
                    nativeAdIds.add(getResources().getString(R.string.todays_3_5_b)); //previous middle native
                    nativeAdIds.add(getResources().getString(R.string.todays_3_5_c)); //previous bottom native

...
public class sure_tips extends Fragment {
...
*/      progressBar=rootView.findViewById(R.id.progressBar);
        ...
        Call<PhoneTodayResponse> call= ApiClient.getClient().getSureTips();
        call.enqueue(new Callback<PhoneTodayResponse>() {
            ...
            public void onResponse(Call<PhoneTodayResponse> call, Response<PhoneTodayResponse> response) {
                ...
                if(response.body().getData().size()==0){
                    ...
                    nativeAdIds.add(getResources().getString(R.string.todays_sure_a)); //previous top native
                    nativeAdIds.add(getResources().getString(R.string.todays_sure_b)); //previous middle native
                    nativeAdIds.add(getResources().getString(R.string.todays_sure_c)); //previous bottom native

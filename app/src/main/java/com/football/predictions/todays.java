...
public class todays extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        webView.setWebViewClient(new WebViewClient());
        webView.setHorizontalScrollBarEnabled(false);
        webView.loadUrl("http://sportpesatips.dx.am/phonetoday.php");
        webView.setWebViewClient(new WebViewClient(){
        ...
        try{
            ...
            bannerAdView.setAdListener(new AdListener() {
                ...
                public void onError(Ad ad, AdError adError) {
                    ...
                    Log.d("awesome","Error in loading todays match banner ad: "+adError.getErrorMessage());
                }

                @Override
                public void onAdLoaded(Ad ad) {
                    Log.d("awesome","todays match banner ad loaded: "+ad);
                }

                @Override
                public void onAdClicked(Ad ad) {
                    Log.d("awesome","todays match banner ad clicked: "+ad);
                }

                @Override
                public void onLoggingImpression(Ad ad) {
                    Log.d("awesome","todays match banner ad impression: "+ad);
                }
            });
            bannerAdView.loadAd();
        }catch (Exception ignored){}*/
        ...
        /*try{
            ...
            nativeAd.setAdListener(new AdListener() {
                ...
                public void onError(Ad ad, AdError error) {
                    ...
                    Log.d("awesome","Error in opening todays fragment native ad: "+error.getErrorMessage());
                }

                @Override
                public void onAdLoaded(Ad ad) {
                    // Ad loaded callback
                    Log.d("awesome","todays fragment Native ad loaded: "+ad);
                    if (nativeAd != null) {
                ...
                public void onAdClicked(Ad ad) {
                    // Ad clicked callback
                    Log.d("awesome","todays fragment Native ad clicked: "+ad);
                }

                @Override
                public void onLoggingImpression(Ad ad) {
                    // Ad impression logged callback
                    Log.d("awesome","todays fragment Native ad impression: "+ad);
                }
            });

 ...
 */
public class tomorrows_1_5 extends Fragment {
        ...
        call.enqueue(new Callback<PhoneTodayResponse>() {
            ...
            public void onResponse(Call<PhoneTodayResponse> call, Response<PhoneTodayResponse> response) {
                ...
                if(response.body().getData().size()==0){
                    ...
                    nativeAdIds.add(getResources().getString(R.string.tomorrows_1_5_a)); //previous top native
                    nativeAdIds.add(getResources().getString(R.string.tomorrows_1_5_b)); //previous middle native
                    nativeAdIds.add(getResources().getString(R.string.tomorrows_1_5_c)); //previous bottom native

                    ArrayList<Game> modifiedGameList=new ArrayList<>();
                    for(Game game:response.body().getData()){
                        if(game.getTip().toLowerCase().contains("over 1.5")){
